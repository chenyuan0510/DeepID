...
2) Make sure that extension package including Numpy, Pandas and [paddlepaddle](https://github.com/paddlepaddle/paddle) 1.8.4 have installed for current python environment; 
